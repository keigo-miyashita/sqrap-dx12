...
private:
	...
	bool CreateSwapChain(const Device& device, const HWND& hwnd, SIZE winSize, const Command& commandQueue, std::wstring name = L"SwapChain");
...
public:
	SwapChain();
	~SwapChain() = default;
	bool Init(const Device& device, const HWND& hwnd, SIZE winSize, const Command& commandQueue, std::wstring name = L"SwapChain");
